...
\tikzset{
basic/.style={rectangle, text width=5cm, text centered,
    rounded corners, minimum height=1.5cm, line width=3pt},
%
history/.style={basic, fill=commit!40, draw=commit},
index/.style={basic, fill=index!50, draw=index},
work/.style={basic, fill=work!50, draw=work},
%
commit/.style={history, text width=2cm, minimum height=1cm},
new commit/.style={commit, double shadow},
branch/.style={commit, fill=branch!50, draw=branch},
HEAD/.style={commit, fill=HEAD!50, draw=HEAD},
old branch/.style={commit, fill=old branch!50, draw=old branch,
    text=black!30},
old HEAD/.style={commit, fill=old HEAD!50, draw=old HEAD,
    text=black!30},
attached HEAD/.style={HEAD, minimum height=2cm},
attached HEAD label/.style={basic, minimum height=1cm, text width=2cm},
